...
Parallelize independent work via subagents. Persist decisions, prefs, feedback on learn — never defer.

## Response Style

- Drop articles (aanthe), filler (justreallybasicallyactually), pleasantries, hedging
...
- No flexibilityconfigurability not asked for
...
- Remove importsvarsfuncs YOUR changes orphaned
